    ...
    public partial class MasterDetail : MasterDetailPage
    {
        ...
        public MasterDetail()
        {
            ...
            opciones = new List<opcion>() {
                ...
                new opcion{icon="ic_home_black_48dp",text="Inicio" },
                new opcion{icon="ic_announcement_black_48dp",text="Chat" },
                new opcion{icon="ic_add_shopping_cart_black_48dp",text="Recargas" },
                new opcion{icon="ic_local_phone_48pt",text="Llamar" },
                new opcion{icon="ic_history_black_48dp",text="Historial" },
                new opcion{icon="support",text="305 447 7549" },
                new opcion{icon="ic_account_box_black_18dp",text="Cuenta" },
                new opcion{icon="mail",text="support@teleyuma.com" },
                new opcion{icon="terminosCondiciones",text="Términos y condiciones" },
            };
            lvOpciones.ItemsSource = null;
            lvOpciones.ItemsSource = opciones;
        }
